...
def main():
    ...
    group_a_file = open('/home/paulomoraes/Projects/blue/back/dataset/group_a.csv', 'a')
    group_b_file = open('/home/paulomoraes/Projects/blue/back/dataset/group_b.csv', 'a')
    group_c_file = open('/home/paulomoraes/Projects/blue/back/dataset/group_c.csv', 'a')
    group_d_file = open('/home/paulomoraes/Projects/blue/back/dataset/group_d.csv', 'a')
    ...
    for r in range(10):
        kmeans = KMeans(n_clusters = 4).fit(bag_of_words)
    ...
    for ix_pdc, value in enumerate(predict):
        for ix_rvw, content in enumerate(reviews):
            if ix_pdc == ix_rvw:
                if value == 0:
                    a = [value, content]
                    group_a.append(a)
