...
arq = open('/home/paulomoraes/Projects/blueway/main/dataset/page/app_2/adobe_air.html')
...
def main():
    ...
    for i in range(0, len(data)):
        ...
        with open('/home/paulomoraes/Projects/blueway/main/dataset/high/full_reviews/full_reviews_high_adobe.csv', 'a') as r:
            r.write(str(struct))
            r.write(',')
            r.write('\n')
            r.close
